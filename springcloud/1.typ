...
- rabbitmq
  ...
  - MQ区别 
    #image("Screenshot_20250819_162404.png")
    - 虚拟主机
    - helloworld案例
    - 发送消息
      + 建立connection
...
- ES
  ...
  - 正向索引和倒排索引
    ...
    - 倒排索引：从关键词到文档的映射
  - 每一条数据就是一个文档
  - 对文档的内容进行分词，得到的词语就是词条
  - #image("Screenshot_20250909_234635.png")
  - Es是基于文档存储， 文档数据会被序列化成json格式后存到ES
  - 索引：相同类型的文档的集合
  #image("Screenshot_20250909_235036.png")
  - ik分词器载入es-plugin
    - iksmart
       - 程序员会分成程序员
    - ikmaxword
